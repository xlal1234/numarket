...
SEARCH.bottom_page_html = function(e, k, j) {
    ...
    if (e <= 1) {
        f += '<span class="prev-disabled">Pre<b></b></span>'
    } else {
    ...
    f += '<span class="page-skip"><em>&nbsp;&nbsp;Total' + k + '&nbsp;&nbsp;&nbsp;&nbsp;To</em><input class="jumpto" type="text" value="' + e + '" onkeydown="javascript:if(event.keyCode==13){SEARCH.page_jump(' + k + "," + j + ');return false;}"/><em>Page</em><a class="btn-skipsearch" value="Confirm" onclick="SEARCH.page_jump(' + k + "," + j + ')" href="javascript:;">Confirm</a></span>';
    $("#pagin-btm").html(f)
};
