...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/taotao-logo.gif" title="Back to Home" alt="Back to Home"></a></div>
    <div class="language"><a href="javascript:void(0);" onclick="toEnCart()"></a></div>
	<div class="progress clearfix">
		<ul class="progress-1">
			<li class="step-1"><b></b>1.My Cart</li>
			<li class="step-2"><b></b>2.Add Info</li>
			<li class="step-3">3.Submit Success</li>
		</ul>
	</div>
</div>
<div class="w cart">
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-goods">Item</div>
        <div class="column t-price">NUPrice</div>
        <div class="column t-promotion">Saved</div>
        <div class="column t-inventory">Stock</div>
        <div class="column t-quantity">No.</div>
        <div class="column t-action">Delete</div>
    </div>
        ...
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-inventory stock-11345721">In Stock</div>
          ...
          <div class="cart-toolbar clearfix">
            <div class="total fr">
                <p><span class="totalSkuPrice">$<fmt:formatNumber value="${totalPrice / 100}" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></span>Total：</p>
                <p><span id="totalRePrice">- $0.00</span>Saved：</p>
            </div>
            <div class="amout fr"><span id="selectedCount">1</span> Item</div>
        </div>
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  ...
                  <a href="/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">Continue</a>
              </span>
          </div>
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="/order/order-cart.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">Check<b></b></a>
                  </span>
