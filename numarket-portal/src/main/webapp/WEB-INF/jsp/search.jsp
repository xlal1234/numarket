...
<title>${query} - Search - NUMarket</title>
...
<div  id="pagin-btm" class="pagin fr" clstag="search|keycount|search|pre-page2">
	<span class="prev-disabled">Pre<b></b></span>
	...
	<a href="search?keyword=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=2" class="next">Next<b></b></a>
	<span class="page-skip"><em>&nbsp;&nbsp;page${totalPages}&nbsp;&nbsp;&nbsp;&nbsp;To</em></span>
</div>
</div>
