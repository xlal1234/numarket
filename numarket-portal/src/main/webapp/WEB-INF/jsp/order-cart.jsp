...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="Rock"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15891588888"/>
		<input type="hidden" name="orderShipping.receiverState" value="MA"/>
		<input type="hidden" name="orderShipping.receiverCity" value="Boston"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="Fenway"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="Columbus Avenue"/>
</form>
...
<div class="step-tit">
	...
	<div class="extra-r">
		<a href="#none" class="ftx-05" onclick="use_NewConsignee()">Add</a>
	</div>
</div>
<div class="step-cont">
					...
					<div class="consignee-item item-selected"
						...
						<div class="op-btns ar">
							<a href="#none"
								...
								fid="137617472">Set as default address</a> <a href="#none"
			...
			<ul id="payment-list">
				...
				<li style="cursor: pointer;" onclick="save_Pay(1);">
					<div class="payment-item item-selected online-payment "
						...
						<b></b> COD<span class="qmark-icon qmark-tip"
				...
				<li style="cursor: pointer;" onclick="save_Pay(4);">
					...
					<div class="payment-item  online-payment "
						...
						<b></b> Online <font class="whiteBarSpanClass hide"
				...
				<li style="cursor: pointer;" onclick="save_Pay(5); ">
					...
					<div class="payment-item online-payment "
						...
						<b></b> Check <span class="qmark-icon qmark-tip"
...
<div class="step-tit">
	<h3>Detail</h3>
	<div class="extra-r">
					<a href="/cart/show.html" id="cartRetureUrl" class="return-edit ftx-05">Back to Cart</a>
			</div>
</div>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">Offer by：NU Market</h4>		         
		...
		<div class="goods-item goods-item-extra">
			...
			<div class="goods-msg">
				...
				<div class="p-price">
					...
					<span class="ml20 p-inventory" skuId="11555193">In Stock</span>
				</div>
				<i class="p-icon p-icon-w"></i><span class="ftx-04">7 days free return</span>
			</div>
			<div class="clr"></div>
		</div>
	</c:forEach>
...
<div class="dis-modes">
	...
	<div class="mode-item mode-tab">
		<h4>
			Delivery Method：（<a id="jd-goods-item" class="ftx-05 alink"
				href="#none"></a>）
		</h4>
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">NU Delivery<i
						class='qmark-icon qmark-tip'
	...
	<div id="part-inv" class="invoice-cont">
		...
		<div class="order-summary">
			...
			<div class="statistic fr">
				...
				<div class="list">
					<span>Shipping：</span> <em class="price" id="freightPriceId">
						￥0.00</em>
				</div>
				<div class="list">
					<span>Total：</span> <em class="price" id="sumPayPriceId">
      ...
      <div class="sticky-wrap">
          ...
          <button type="submit" class="checkout-submit btn-1" 
          	...
          	Submit
                    ...
                    <span class="total">Total：<strong id="payPriceId">￥<fmt:formatNumber value="${totalPrice / 100}" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></strong>
          </span>
