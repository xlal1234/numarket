    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            ...
            <div class="form ">
                ...
                <div id="capslock"><i></i><s></s>CapsLock Is On</div>
                ...
                <div class="item login-btn2013">
                    <input type="button" class="btn-img btn-entry" id="loginsubmit" value="login" tabindex="8" clstag="passport|keycount|login|06"/>
                </div>
            </div>
        </div>
        <div class="free-regist">
            <span><a href="/page/register" clstag="passport|keycount|login|08">Free Regist&gt;&gt;</a></span>
        </div>
    </div>
</form>
<script type="text/javascript">
	...
	var LOGIN = {
			checkInput:function() {
				...
				if ($("#nloginpwd").val() == "") {
					alert("You Need Password To Keep Your Account Safe.");
					$("#nloginpwd").focus();
					return false;
				}
				return true;
			...
			doLogin:function() {
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						...
						alert("Login Faild，because" + data.msg);
						$("#loginname").select();
					}
				});
			},
